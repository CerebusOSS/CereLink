///////////////////////////////////////////////////////////////////////////////////////////////////
/// @file   central_adapter.cpp
/// @brief  Diagnostic tool for testing CereLink and Central compatibility
///
/// Instantiates a CentralAdapter in order to attach to Central's shared memory.
///
/// Usage:
///   central_adapter [instance]
///   central_adapter           # Default: instance 0
///   central_adapter 1         # Instance 1 (for multi-instance setups)
///////////////////////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char* argv[]) {
    ...
    auto centralAdapter = cbshm::makeCentralAdapter();
    if (centralAdapter.isError()) {
        std::cout << centralAdapter.error() << std::endl;
    }
