...
constexpr uint32_t CENTRAL_cbVERSION_MAJOR = 3;
constexpr uint32_t CENTRAL_cbVERSION_MINOR = 11;
...
constexpr uint32_t CENTRAL_cbMAXPROCS = 1;          ///< Central supports up to 1 NSPs
constexpr uint32_t CENTRAL_cbNUM_FE_CHANS = 256;    ///< Central supports 256 FE channels
...
constexpr uint32_t CENTRAL_cbCER_UDP_SIZE_MAX = 1452;
...
/// N-Trode count
constexpr uint32_t CENTRAL_cbMAXNTRODES = CENTRAL_cbNUM_ANALOG_CHANS / 2;  ///< = 136

/// Analog output gain channels (Central's multi-instrument count)
constexpr uint32_t CENTRAL_AOUT_NUM_GAIN_CHANS = CENTRAL_cbNUM_ANAOUT_CHANS + CENTRAL_cbNUM_AUDOUT_CHANS;  ///< = 6

/// Spike cache constants
constexpr uint32_t CENTRAL_cbPKT_SPKCACHEPKTCNT = 400;                          ///< Packets per channel cache
constexpr uint32_t CENTRAL_cbPKT_SPKCACHELINECNT = CENTRAL_cbNUM_ANALOG_CHANS;  ///< One cache per channel
...
typedef struct {
    ...
    cbPKT_SS_NOISE_BOUNDARY pktNoiseBoundary[CENTRAL_cbNUM_ANALOG_CHANS]; ///< Noise boundaries per channel
