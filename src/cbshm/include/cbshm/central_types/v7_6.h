...
constexpr uint32_t CENTRAL_cbMAXPROCS = 3;          ///< Central supports up to 3 NSPs
...
/// N-Trode count
constexpr uint32_t CENTRAL_cbMAXNTRODES = CENTRAL_cbNUM_ANALOG_CHANS / 2;  ///< = 280
...
static_assert(sizeof(cbPKT_GROUPINFO) == 1168);
...
static_assert(sizeof(cbCFGBUFF) == 2221912);
...
static_assert(sizeof(cbPcStatus) == 6160);
