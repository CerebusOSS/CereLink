...
#ifndef CBSHM_CENTRAL_TYPES_V7_8_H
#define CBSHM_CENTRAL_TYPES_V7_8_H
...
constexpr uint32_t CENTRAL_cbVERSION_MINOR = 2;
...
constexpr uint32_t CENTRAL_cbMAXPROCS = 4;          ///< Maximum supported NSPs
constexpr uint32_t CENTRAL_cbNUM_FE_CHANS = 768;    ///< Maximum supported front-end channels
constexpr uint32_t CENTRAL_cbMAXGROUPS = 8;         ///< Sample rate groups
constexpr uint32_t CENTRAL_cbMAXFILTS = 32;         ///< Digital filters
constexpr uint32_t CENTRAL_cbMAXVIDEOSOURCE = 1;    ///< Maximum number of video sources
constexpr uint32_t CENTRAL_cbMAXTRACKOBJ = 20;      ///< Maximum number of trackable objects
...
static_assert(sizeof(cbSPIKE_SORTING) == 2052312);
...
static_assert(sizeof(cbCFGBUFF) == 3214620);
...
static_assert(sizeof(cbSPKBUFF) == 101393616);
...
static_assert(sizeof(cbPcStatus) == 8476);
...
static_assert(sizeof(cbRECBUFF) == 805306384);
...
#endif // CBSHMEM_CENTRAL_TYPES_V7_8_H
